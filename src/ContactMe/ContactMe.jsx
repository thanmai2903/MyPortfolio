...
function ContactMe() {
  ...
  return (
    <div
      style={{ marginTop: 30 }}
      className=" mt-0 sm:mt-0 lg:mt-10 text-xs sm:text-xl lg:text-2xl"
    >
      <button className="last">
        ...
        <div className="flex" style={{ marginBottom: 20 }}>
          <div className="div1-contact">
            ...
            <div className="leading-normal sm:leading-loose">
            ...
            <div className="flex" style={{ marginTop: 28 }}>
              ...
              <div className="fos ml-2">thanmaipalla@gmail.com</div>
            </div>
            <div className="flex">
              <div>
                <img
        ...
        <hr />
        <span className="text-xl mt-0 sm:mt-0 lg:mt-10 ml-0 sm:ml-0 lg:ml-32">
          Terms and Privacy <span> Policy Follow me on </span>
        </span>
        <a
